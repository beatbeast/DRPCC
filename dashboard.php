    ...
    <header>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
            <div class="container-fluid">
                ...
                <a class="navbar-brand waves-effect" href="" target="_blank">
                    <strong class="blue-text">DRPCC</strong>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="" target="_blank">About DRPCC</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        ...
                        <li class="nav-item">
                            <a href="log-out.php" class="nav-link border border-light rounded waves-effect">
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <a class="logo-wrapper waves-effect">
                <img src="img/webczar.jpg" class="img-fluid" alt="">
            </a>
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="storage.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-table mr-3"></i>Storage</a>
                <!-- <a href="apache-jmeter/bin/ApacheJMeter.jar" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-map mr-3"></i>JMeter</a> -->
                <a href="#" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-money mr-3"></i>Implementation</a>
                <a href="eris/index.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-money mr-3"></i>ERIS</a>
                <a href="ems/index.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-money mr-3"></i>EMS</a>
                <a href="freelancer/index.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-money mr-3"></i>Freelancer</a>
                <a href="streaming.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-play mr-3"></i>Video Streaming</a>
            </div>
            <!-- Sidebar -->
    ...
    <footer class="page-footer text-center font-small primary-color-dark darken-2 mt-4 wow fadeIn">
       ...
       <!--  <div class="pt-4">
        ...
        <div class="pb-4">
            ...
            <a href="https://plus.google.com/#4" target="_blank">
        ...
        <div class="footer-copyright py-3">
            © 2019 Copyright:
            <a href="beatbeast.php" target="_blank"> beatbeast </a>
        </div>
        <!--/.Copyright-->

                ...
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/playground (6).JPG" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Nacoss Launcheon</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            FNS playing ground
                            </p>
                            <p class="definition"><!--event content definition-->
                            All computer science students of all levels are to participate because some students and staff will be awarded.
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/playground (3).jpg"class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            ...
                            <p class="definition"><!--event content definition-->
                            This programme is for all natural science students and the lecturers to empower and nurish everyone in his/her career.
                            </p>
                            <hr class="customline2"><!--css modified horizontal line-->
                            <button type="button" class="btn btn-default btn-lg"><!--view details button (no function implemented)-->
                            View Details  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->

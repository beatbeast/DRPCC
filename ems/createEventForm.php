        ...
        <div class = "content">
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="Capacity" class="col-md-2 control-label">Capacity</label><!--cost-->
                        <div class="col-md-5">
                            <input type="number" class="form-control" id="Capacity" name="Capacity" value="<?php echoValue($formdata, 'Capacity')?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
                            <span id="CapacityError" class="error"><!--error message for invalid input-->
                                <?php echoValue($errors, 'Capacity');?>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">

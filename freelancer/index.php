	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Check the Best <span>Deal</span></h3>
						<p>Special for today</p>
						<a class="hvr-outline-out button2" href="Market.php">Shop Now </a>
					</div>
				</div>
			</div>
			<div class="item item2"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Get Your Job  <span>Done</span></h3>
						<p>Meet Freelancers</p>
						<a class="hvr-outline-out button2" href="freelancers.php">Meet Freelancers</a>
					</div>
				</div>
			</div>
			<div class="item item3"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Sell and buy<span>Your Product</span></h3>
						<p>With Ease</p>
						<a class="hvr-outline-out button2" href="market.php">Shop Now </a>
					</div>
				</div>
			...
			<div class="item item4"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Are you a  <span>Freelancer?</span></h3>
						<p>Sign Up above to get Started</p>
						<a class="hvr-outline-out button2" href="freelancer.php">Meet Freelancers</a>
					</div>
				</div>
			</div>
...
<!-- /new_arrivals --> 
	<div class="new_arrivals_agile_w3ls_info"> 
		<div class="container">
		    <h3 class="wthree_text_info">Hot <span>Deals</span></h3>		

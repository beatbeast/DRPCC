...
<div class="header" id="home">
	<div class="container">
		...
		?>
			...
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:favourtunde999@yahoo.com">favourtunde999@yahoo.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
					...
					<li  <?php if($page=='freelancer'){ echo 'class="menu__item dropdown menu__item--current"'; } else { echo 'class="menu__item dropdown"'; } ?>    >
					   <a class="menu__link" href="freelancer.php" class="dropdown-toggle" data-toggle="dropdown">Freelancers <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="WebDesign.php">Web Designer</a></li>
									<li><a href="graphics.php">Graphics Designer</a></li>
									<li><a href="MobileApp.php">Mobile App Developers</a></li>
									<li><a href="systemapp.php">System App Developers</a></li>
								</ul>
					</li>					

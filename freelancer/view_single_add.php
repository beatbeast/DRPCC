...
require('header.php');
	...
	//this is the query for the product advert
	{
        $query = "SELECT * FROM product_advert WHERE Product_id='$id'";
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					?>
						<li data-thumb="product_pictures/<?php echo $row1['pic_name']; ?>">
							<div class="thumb-image"> <img data-imagezoom="true" class="img-responsive" src="product_pictures/<?php echo $row1['pic_name']; ?>" /> </div>
						</li>
					<?php
						}
					?>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price"><?php echo "$".$row['Normal_price']; ?></span> <del><?php echo "$".$row['High_price']; ?></del></p>
					<div class="rating1">
					...
					<!--/tab_one-->
					   <div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>ABOUT <?php echo $row['Product_name']; ?></h6>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										...
										<div class="bootstrap-tab-text-grid-right">
											<ul>
												<li><a href="#"><?php echo $fname; ?></a></li>
												<li><a href="#"><i class="fa fa-reply-all" aria-hidden="true"></i> Reply</a></li>
											</ul>
											<p>This is just the sellers informations</p>
										</div>
										<div class="clearfix"> </div>
						             </div>
						   ...
						   <div class="tab3">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6><?php echo $row['Product_name']; ?></h6>
							   <p><?php echo $row['Description']; ?></p>
							   <p>There are varieties of colours and sizes of this product and it is usedful for both man and women, youths and children.</p>
							</div>
						</div>
					</div>
				</div>	

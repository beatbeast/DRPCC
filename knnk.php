        ...
        <section class="text-center cta cta-4 space--xxs border--bottom bg--dark">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <span>Over 290 interface blocks, 140 demo pages and Variant Page Builder.
                                <a href="#">Purchase Stack</a> for $17 USD.</span>
                        </div>
                    </div>
                    <!--end of row-->
                </div>
                <!--end of container-->
                     ...
                     <td align="">
                        ...
                        <!--<button><a href="mail.php?id=<?php //echo $row["id"]; ?>">Mail</a></button>-->
                        <a href=".php?id=<?php echo $row["id"]; ?>"><button type="reply" class="btn btn-secondry">Reply</button></a>
                        </td>
                    </tr>
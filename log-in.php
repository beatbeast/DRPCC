...
<html>
<head>
<title>DYNAMIC RESOURCE PROVISIONING FOR CLOUD COMPUTING.:.Login</title>
<link rel="icon" href="img/webczar.jpg">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="img/webczar.jpg"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('Login_v12/images/art-1.jpg');">
			<div class="wrap-login100 p-t-100 p-b-30">
				<form action="loginmodule.php" method="post" class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="Login_v12/images/webczar.jpg" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-10 p-b-30">
						DYNAMIC RESOURCE PROVISIONING FOR CLOUD COMPUTING
					</span>

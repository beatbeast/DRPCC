...
<head>
<meta charset="utf-8">
<title>ACU | OSRS | <?php echo $title;?></title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link rel="icon" href="img/logo.jpeg">
<meta name="description" content="" />
<meta name="author" content="http://royeweb.com" />
<!-- css -->
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+234) 123-456-789</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">ACU | OSRS<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Job By School</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Teaching Jobs <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">School</a></li>
                        ...
                        <li class=""><a href="../index.php?">BAck to DRPCC</a></li>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <p>
            ...
            <i class="icon-envelope-alt"></i> mictunwa21boi@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=company">School</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>2019 &copy; Online School Recruitment System. All rights reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">

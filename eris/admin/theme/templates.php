...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>ACU | OSRS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ACU | OSRC</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">Online School Recruitment System </a>.</strong> All rights
    reserved.
  </footer>
